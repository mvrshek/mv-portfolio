...
const projects: Record<string, Project> = {
  ...
  "mvp-tac": {
    ...
    sections: [
...

      {
        ...
        text: "Aside from packaging the hardware to fit in such a small area, I worked on the design side of the sensor, and fabricated sensor components and testing apparatus. Developing the model for the outer shell was an iterative process, because we wanted to minimize external bonding agents, while still needing to fabricate the housing in 2 components due to the nature of the scope's assembly. For earlier iterations, I modeled a snap joint fixture that allowed the components to be snapped into place once the camera setup was arranged in place. The snap joint idea was scrapped due to the difficulty of resin printing such a small joint, and we eventually settled on a later revision that features slits for bonding agents so as not to obstruct the cameras' field of view. When it was time to test the sensor, I also fabricated phantom exposed and subdermal tumors using varying silicone mixtures which were used to test the accuracy of our force estimation in a practical scenario. The process for fabricating these tumors required 3D printed molds which I designed in Siemens NX, and the silicone creation process was similar to the process used to make the photoelastic material native to the elastomer module which I also fabricated.",
...

      {
        ...
        text: "The testing setup, and in depth results profile is detailed in the 2026 IROS accepted publication: MVP-Tac: A Miniaturized Dual-Modal Vision and Photoelastic Tactile Sensor for Robot-Assisted Minimally Invasive Surgery, of which I was named a co-author due to heavy contributions to the project.",
  ...
  windracers: {
    ...
    overview:
      "Windracers is a Purdue Vertically Integrated Project centered around unmanned aircraft systems and autonomous flight.",
  ...
  HueTac: {
    ...
    role:
      "I worked on the mechanical design and integration of the tactile sensing system, including the physical structure and imaging components used to capture deformation and color changes.",
